...
"""
Tiny Imagenet Resnet-32 Experiment
---------------------------------
...
from tiny_imagenet import train_args
from tiny_imagenet import train

if __name__ == '__main__':
    config = train_args.parse_cmd_arguments(mode='resnet_tiny_imagenet')
