...
def parse_cmd_arguments(mode='resnet32_cifar', default=False, argv=None):
    ...
    if mode == 'resnet_cifar':
        description = 'CIFAR-10/100 CL experiment using a Resnet'
...
def special_cl_options(agroup):
    ...
    agroup.add_argument('--use_cifar10', action='store_true',
                        help='Determine if to start training with cifar10 or not')
